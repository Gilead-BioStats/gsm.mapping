...
The [gsm.mapping](https://github.com/Gilead-BioStats/gsm.mapping)
package provides the necessary functions and workflows to perform the
data transformation from raw/source datasets to appropriate domains.
...
goal of [gsm.mapping](https://github.com/Gilead-BioStats/gsm.mapping) is
...
[gsm.mapping](https://github.com/Gilead-BioStats/gsm.mapping). The only
...
Extensions
vignette](https://gilead-biostats.github.io/gsm.core/articles/gsmExtensions.html#mappings).
