...
Currently, there exist 20 domains that have respective workflows that require mapping from source/raw data. 14 are general domains used across several packages and extensions:
